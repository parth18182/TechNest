import { AppWindowIcon, CodeIcon, LoaderIcon } from "lucide-react";
...
function Profile() {
    ...
    const [updateUser, setUpdateUser] = useState({
        ...
        city: user?.city || '',
        zipcode: user?.zipcode || '', // ✅ use lowercase `zipcode`
                            ...
                            <div className="w-full flex gap-10 justify-between   px-7 max-w-2xl">
                                ...
                                >
                                    ...
                                    <Button
                                        ...
                                        onClick={loading}
                                        className={
                                            "w-full bg-pink-600 mt-4 hover:bg-pink-700 text-white font-semibold cursor-pointer py-2 rounded-lg"
                                        }
                                    >
                                        {load ? <LoaderIcon className="mr-2 h-4 w-4 animate-spin inline-block" /> : "Update Profile"}
                                    </Button>
                                </form>
                            </div>
                        </div>
