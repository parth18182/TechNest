...
function AddProduct() {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            setLoading(true)
            const res = await axios.post(`${import.meta.env.VITE_URL}/api/products/add`,formData, {
                headers: {
    ...
    return (
        <div className='pl-87.5 py-20 pr-20 mx-auto px-4 bg-gray-100'>
                ...
                <CardContent>
                    <div className='flex flex-col gap-2'>
                        ...
                        <div>
                            <div className='grid gap-2'>
                                <Label>Price</Label>
                                <Input type={'number'} name="productPrice" value={productData.productPrice} onChange={handleChange} placeholder="xxxx" required />
                            </div>
                        ...
                        <CardFooter className={'flex flex-col gap-2'}>
                            <Button onClick={submitHandler} disabled={loading} className={'w-full bg-pink-600 cursor-pointer mt-10'} type="submit" >
                                {
